...
from datasets.ssv2 import SSV2FeatureDataset
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='animalkingdom', choices=['animalkingdom', 'charades', 'animalkingdom-new-actions', 'animalkingdom-new-species', 'ucf-hmdb', 'hmdb-ucf', 'ucf', 'hmdb', 'ssv2'],
...
def main():
    ...
    if args.dataset == 'animalkingdom':
        ...
        train_dataset = SSV2FeatureDataset(
            split='train',
            features_root=args.data_root,
        ...
        val_dataset = SSV2FeatureDataset(
            split='val',
            features_root=args.data_root,
            data_root='../ssv2/labels',
            max_len=args.max_length,
